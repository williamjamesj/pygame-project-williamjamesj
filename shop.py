...
class shopScreen():
    def __init__(self):
        ...
        self.spaceships = [["yellowspaceship",10,0.1,3,1,0],["greenspaceship",10,0.1,3,0.5,50000]] # The lists store ships in order: appearance,maxspeed,acceleration,turnspeed,firerate
