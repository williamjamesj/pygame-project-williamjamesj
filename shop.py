...
class shopScreen():
    def __init__(self):
        ...
        self.spaceships = [["yellowspaceship",10,0.1,3,1,0,0],["redspaceship",15,0.2,5,2,0,2],["bigspaceship",20,0.1,1,0.5,25000,5]] # The lists store ships in this order: appearance,maxspeed,acceleration,turnspeed,firerate
