...
class shopScreen():
    def __init__(self):
        ...
        self.spaceships = [["yellowspaceship",10,0.1,3,1,0],["redspaceship",15,0.15,3,2,50000],["greenspaceship",10,0.1,3,0.5,25000]] # The lists store ships in this order: appearance,maxspeed,acceleration,turnspeed,firerate
