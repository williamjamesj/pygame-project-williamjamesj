...
class shopScreen():
    def __init__(self):
        ...
        self.spaceships = [["yellowspaceship",10,0.1,3,1,0],["redspaceship",15,0.2,4,2,50000],["greenspaceship",10,0.1,3,0.5,25000]] # The lists store ships in order: appearance,maxspeed,acceleration,turnspeed,firerate
    ...
    def displayShop(self):
        ...
        buttons.Button(500,75,[globals.dimensions[0]/2-250,410-globals.dimensions[1]/2],globals.screen,f"{globals.languagesdict['acceleration']}: {str(math.floor(self.spaceships[self.currentship][2]*10))}",50)
        ...
        buttons.Button(500,75,[globals.dimensions[0]/2-250,570-globals.dimensions[1]/2],globals.screen,f"{globals.languagesdict['firerate']}: {str(math.floor(1/self.spaceships[self.currentship][4]))}",50)
