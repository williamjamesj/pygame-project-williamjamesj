...
class shopScreen():
    def __init__(self):
        ...
        self.spaceships = [["yellowspaceship",10,0.1,3,1,0,0],["greenspaceship",10,0.1,3,0.5,25000,0],["redspaceship",15,0.15,5,2,50000,2],["bigspaceship",20,0.05,1,0.1,100000,5]] # The lists store ships in this order: appearance,maxspeed,acceleration,turnspeed,firerate
